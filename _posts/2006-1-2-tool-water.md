...
本文记录 **WaterSite（多租户水站售水系统）** 从选型、建模、本地联调到服务器域名与小程序上线的完整流程。代码仓库地址 [https://github.com/feng6917/watersite](https://github.com/feng6917/watersite)，路径与命令均来自真实工程，便于按图索骥。

<!-- more -->

<h2 id="c-1-0" class="mh1">一、业务与产品模型</h2>
...
<h2 id="c-2-0" class="mh1">二、技术选型与仓库结构</h2>

- 2.1 # 为什么这样选

| 层次 | 选型 | 理由 |
|------|------|------|
| 后端 | **Go 1.21 + Kratos v2** | gRPC/HTTP 双协议，Proto 契约清晰 |
...
<h2 id="c-3-0" class="mh1">三、数据库与领域模型</h2>
...
<h2 id="c-4-0" class="mh1">四、后端：搭建与调试</h2>
...
<h2 id="c-5-0" class="mh1">五、平台 / 商家 Web 管理端</h2>
...
- 订单管理：接单、派单与状态跟踪
  ...
  ![img](../images/2026-6-30/11.png)

- 商品管理：上架、库存与价格维护

  ![img](../images/2026-6-30/12.png)

- 骑手管理：在线状态、骑士码与配送统计

  ![img](../images/2026-6-30/13.png)

- 押金卡管理：押桶押金、退卡申请

  ![img](../images/2026-6-30/14.png)

- 配送费管理：骑手配送费趋势与排行

  ![img](../images/2026-6-30/15.png)

- 店铺设置：商家信息、配送地址与首页轮播

  ![img](../images/2026-6-30/16.png)


<h2 id="c-6-0" class="mh1">六、用户小程序（含骑手）</h2>
...
- 首页：选水站、分类浏览与加购
  ...
  ![img](../images/2026-6-30/1.png)

- 购物车：按水站结算

  ![img](../images/2026-6-30/2.png)

- 我的：订单入口、地址、押金卡与切换骑手

  ![img](../images/2026-6-30/3.png)

- 编辑地址：地图选点自动填充地区

  ![img](../images/2026-6-30/4.png)

- 消息中心：订单状态推送

  ![img](../images/2026-6-30/5.png)

- 设置：昵称头像与绑定骑士码

  ![img](../images/2026-6-30/6.png)

- 6.5 # 骑手端界面

- 工作台：待接单、配送中与已完成

  ![img](../images/2026-6-30/7.png)

  ![img](../images/2026-6-30/8.png)

- 骑手我的：今日数据与累计收入

  ![img](../images/2026-6-30/9.png)

- 订单详情：配送地址、押退桶与签收拍照

  ![img](../images/2026-6-30/10.png)


<h2 id="c-7-0" class="mh1">七、服务器、域名与 Nginx</h2>
...
<h2 id="c-8-0" class="mh1">八、小程序隐私保护与审核</h2>
...
- 8.2.2 # （2）选择的位置信息（ChooseLocation）
...
<h2 id="c-9-0" class="mh1">九、微信开发者工具与真机调试</h2>
...
<h2 id="c-10-0" class="mh1">十、构建上传与预览发布</h2>
...
<h2 id="c-11-0" class="mh1">十一、常用命令速查</h2>
...
<h2 id="c-12-0" class="mh1">附录：推荐阅读顺序（新人上手）</h2>
...
<div class="mi1">
    <strong>目录</strong>
        <ul style="margin: 10px 0; padding-left: 20px; list-style-type: none;">
            <li style="list-style-type: none;"><a href="#c-1-0">一、业务与产品模型</a></li>
            <ul style="padding-left: 15px; list-style-type: none;"></ul>
            <li style="list-style-type: none;"><a href="#c-2-0">二、技术选型与仓库结构</a></li>
            <ul style="padding-left: 15px; list-style-type: none;"></ul>
            <li style="list-style-type: none;"><a href="#c-3-0">三、数据库与领域模型</a></li>
            <ul style="padding-left: 15px; list-style-type: none;"></ul>
            <li style="list-style-type: none;"><a href="#c-4-0">四、后端：搭建与调试</a></li>
            <ul style="padding-left: 15px; list-style-type: none;"></ul>
            <li style="list-style-type: none;"><a href="#c-5-0">五、平台 / 商家 Web 管理端</a></li>
            <ul style="padding-left: 15px; list-style-type: none;"></ul>
            <li style="list-style-type: none;"><a href="#c-6-0">六、用户小程序（含骑手）</a></li>
            <ul style="padding-left: 15px; list-style-type: none;"></ul>
            <li style="list-style-type: none;"><a href="#c-7-0">七、服务器、域名与 Nginx</a></li>
            <ul style="padding-left: 15px; list-style-type: none;"></ul>
            <li style="list-style-type: none;"><a href="#c-8-0">八、小程序隐私保护与审核</a></li>
            <ul style="padding-left: 15px; list-style-type: none;"></ul>
            <li style="list-style-type: none;"><a href="#c-9-0">九、微信开发者工具与真机调试</a></li>
            <ul style="padding-left: 15px; list-style-type: none;"></ul>
            <li style="list-style-type: none;"><a href="#c-10-0">十、构建上传与预览发布</a></li>
            <ul style="padding-left: 15px; list-style-type: none;"></ul>
            <li style="list-style-type: none;"><a href="#c-11-0">十一、常用命令速查</a></li>
            <ul style="padding-left: 15px; list-style-type: none;"></ul>
            <li style="list-style-type: none;"><a href="#c-12-0">附录：推荐阅读顺序（新人上手）</a></li>
            <ul style="padding-left: 15px; list-style-type: none;"></ul>
        </ul>
</div>
